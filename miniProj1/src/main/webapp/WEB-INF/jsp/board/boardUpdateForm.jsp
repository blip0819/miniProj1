...
<div id="container">
    <img src="img/건강챙겨.png" width=360px>
            ...
            <div class="form-group">
                <label>작성자 : </label>
                <input type="text" id="bwriter" name="bwriter" value="${board.bwriter}">
            </div>
		...
		<br> 
				<input type="submit" value="수정">
       			<a href="board?action=boardView&bno=${board.bno}">취소</a>
       	</form>
		    ...
		    rForm.addEventListener("submit", e => {
		        ...
		        fetch("board", {
		            ...
		            if (json.status == 0) {
		                ...
		                location = "board?action=boardView&bno=" + bno.value;
		            } else {
